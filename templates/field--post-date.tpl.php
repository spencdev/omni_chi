...
/**
 * @file field--post-date.tpl.php
 * Omni chi field theme override for Display Suite's post_date field. We use 
 * the HTML5 <time> element.
 *
 * Available variables:
 * - $datetime: The ISO 8601 date format for the time element.
